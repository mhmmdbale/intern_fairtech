                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form action="${createLink(uri: '/user/add')}" method="post">
                                ...
                                <button type="submit" style="background-color: #2877ed !important; color: white" class="btn btn-block btn-submit">Daftar</button>
                                <div class="auth-options">
                                    <a href="#" class="forgot-link" style="color: #2877ed">Sudah punya akun?</a>
                                </div>
                            </form>
                        </div>
                    </div>
